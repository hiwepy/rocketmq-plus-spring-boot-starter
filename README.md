...
**Spring Boot Starter for rocketmq-plus**
...
**rocketmq-plus-spring-boot-starter** is a Spring Boot starter that integrates **rocketmq-plus** for applications using rocketmq-plus. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume rocketmq-plus capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using rocketmq-plus |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for rocketmq-plus |
| JDK | `17` |
| Coordinates | `io.github.easy4j:rocketmq-plus-spring-boot-starter:1.0.0.RELEASE` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers rocketmq-plus beans automatically |
| Property Binding | ✅ Stable | Binds `rocketmq.plus.*` to `RocketmqProducerProperties` |
| `TransactionCheckListener` bean | ✅ Stable | Auto-registered via RocketmqProducerAutoConfiguration, RocketmqPullConsumerAutoConfiguration, RocketmqPushConsumerAutoConfiguration, RocketmqPushEventHandlerAutoConfiguration |
...
|---|---|---|
| `TransactionCheckListener` | classpath + property | not created |
| `DefaultMQProducer` | classpath + property | not created |
| `RocketmqProducerTemplate` | classpath + property | not created |
